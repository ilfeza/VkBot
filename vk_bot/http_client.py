...
class HttpClient:
        ...
        try:
            for attempt in Retrying(
                ...
                retry=retry_if_exception(
                    ...
                    and e.response.status_code in _RETRY_STATUSES
                ),
                reraise=True,
            ):
                with attempt:
    ...
    def get(
        ...
        *,
        ...
        return self._request("GET", url, params=params, timeout=timeout or self._config.timeout)
    ...
    def post(
        ...
        *,
        ...
        return self._request("POST", url, data=data, params=params, files=files, timeout=timeout or self._config.timeout)
